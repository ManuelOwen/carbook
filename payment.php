...
<?php
  ...
  $query = "SELECT * FROM `order` WHERE carId = $carId AND duration = '$duration' AND userId = '$userId'";
  $execute = mysqli_query($connection, $query);
  $row = mysqli_fetch_array($execute);
  $amount = $row['amount'];
    ...
    <div class="container d-flex justify-content-center">
      <div class="card mt-5 px-3 py-4">
        ...
        <div class="media mt-3 pl-2">
            ...
            <form class="row g-3" action="./api/stk_initiate.php" method="POST">
            
                <div class="col-12">
                  <label for="inputAddress" class="form-label">Amount</label>
                  <input type="text" readonly value="<?php echo $amount ?>" class="form-control" name="amount" placeholder="Enter Amount">
                </div>
                <div class="col-12">
                  <label for="inputAddress2" class="form-label" >Phone Number</label>
                  <input type="text" value="254<?php echo $phone ?>"  class="form-control" name="phone"  placeholder="Enter Phone Number">
                </div>
