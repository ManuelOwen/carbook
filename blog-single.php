        ...
        <div class="row">
          <div class="col-md-8 ftco-animate">
            ...
            <?php
                ...
                $query = "SELECT c.message , c.time , u.name FROM comments AS c LEFT JOIN users AS u  ON u.id = c.userId WHERE c.userId = $userId";
                $execute = mysqli_query($connection,$query);
                
            ?>
            <div class="pt-5 mt-5">
              <h3 class="mb-5"><?php echo mysqli_num_rows($execute) ?> Comments</h3>
              ...
              <div class="comment-form-wrap pt-5">
                ...
                <form action="./api/comments.php" method='POST' class="p-5 bg-light">
                  <div class="form-group">
                    <label for="name">Name *</label>
                    <input type="text" value=<?php echo $_SESSION['user'] ?> class="form-control" id="name">
                  </div>
                  <div class="form-group">
                    <label for="email">Email *</label>
                    <input type="email"  value=<?php echo $_SESSION['email'] ?>  class="form-control" id="email">
                  </div>
                  <div class="form-group">
